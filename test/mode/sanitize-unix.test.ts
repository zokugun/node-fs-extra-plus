...
const tests = [
	...
	{ input: '+44', value: '+0o0044' },
	{ input: '-44', value: '-0o0044' },
	{ input: '+22', value: '+0o0022' },
	{ input: '-22', value: '-0o0022' },
...
beforeAll(() => {
	mockPlatform = vi.spyOn(process, 'platform', 'get').mockReturnValue('linux');
});
...
for(const { input, error, value } of tests) {
	it(`sanitize - unix - ${testname(input)}`, () => {
