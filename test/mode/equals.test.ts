...
const tests = [
	...
	{ input: ['a=rwx', 'a=rw'], output: false },
	{ input: ['a=rwx', 'a=rwx'], output: true },
	{ input: ['a=rwxst', 'a=rwx'], output: false },
	{ input: ['a=rwxst', 'a=rwxst'], output: true },

	// Combining
	{ input: ['a+x', 'o+x,g+x'], output: false },
	...
	{ input: ['o+x', 'o+x', 'o+r'], output: false },
	{ input: ['o+xr', 'o+x', 'o+r'], output: false },
	{ input: ['o+xr', 'o+x,o+r', 'o+r'], output: false },
	{ input: ['o+xr', 'o+x,o+r', 'o+r,o+x'], output: true },
	{ input: ['o-x', 'o+', 'o+x'], output: false },
];

for(const { input, output } of tests) {
	it(`equals - ${testname(input)}`, () => {
		const result = fse.mode.equals(...(input as Parameters<typeof fse.mode.equals>));
